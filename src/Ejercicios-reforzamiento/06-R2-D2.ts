...
/* El Ejercicio Original solicita el personaje Luke Skywalker pero actualmente en la API no le aparece Especie,
por lo cuál se usará el Ejercicio con el personaje R2-D2 /people/3/ */
...
(() =>{
    ...
    // Obteniendo Respuesta Esperada Básica
    // switchMap( resp => getRequest( resp.species[0] ) )

    // Obteniendo Respuesta Esperada con el uso del ZIP
